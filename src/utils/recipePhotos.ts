...
const PHOTOS: Record<string, string[]> = {
  ...
  soup_asian: [
    u("photo-1680137248903-7af5d51a3350"),
    u("photo-1652088079703-38f4a8d6b981"),
  ],
  soup_creamy: [
  ...
  rice: [
    u("photo-1516684732162-798a0062be99"),
  ...
  roasted_vegetables: [
    u("photo-1636743716922-1884c23fb6f6"),
    u("photo-1596464716059-f81da526557b"),
  ],
  curry: [
    u("photo-1565557623262-b51c2513a641"),
    u("photo-1588166524941-3bf61a9c41db"),
  ],
  tacos: [
  ...
  flatbread: [
    u("photo-1588315029754-2dd089d39a1a"),
    u("photo-1584365685547-9a5fb6f3a70c"),
  ],
  energy_balls: [
    u("photo-1596723455658-72ebb0d12edd"),
    u("photo-1678554500191-3885a6fbf8c2"),
  ],
  stuffed_vegetables: [
    u("photo-1596464716059-f81da526557b"),
  ...
  lentil: [
    u("photo-1510431198580-7727c9fa1e3a"),
    u("photo-1605909388460-74ec8b204127"),
  ],
  mediterranean: [
...
export function getRecipePhoto(name: string, ingredients: string[]): string {
  ...
  // Most-specific matchers first — order matters (first match wins)
