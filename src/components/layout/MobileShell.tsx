...
export default function MobileShell({ children }: { children: ReactNode }) {
  return (
    <div className="w-full bg-bg min-h-screen sm:flex sm:items-center sm:justify-center sm:py-6">
      <div
        id="mobile-shell-frame"
        className="relative w-full sm:max-w-[430px] h-screen sm:h-[900px] sm:max-h-[94vh] sm:rounded-[36px] overflow-hidden sm:border sm:border-border bg-bg sm:shadow-2xl flex flex-col"
      >
