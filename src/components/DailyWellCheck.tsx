...
const ACTIVITY_LABELS: Record<string, string> = {
  ...
  breathwork_extended: "Completed an extended breathwork session",
...
const ACTIVITY_EMOJI: Record<string, string> = {
  ...
  sleep_log: "😴",
  breathwork: "🌬️",
  breathwork_extended: "🌬️",
  breathwork_calm_kit: "🌬️",
  stretching: "🧘",
  resistance_training: "💪",
  well_activity: "⭐",
  event_attend: "📅",
...
const POINTS_GUIDE = [
  ...
  { emoji: "🌬️", label: "Daily breathwork", pts: 15 },
  { emoji: "🌬️", label: "Extended breathwork session", pts: 20 },
  { emoji: "🌬️", label: "Calm Toolkit tool", pts: 10 },
  ...
  { emoji: "🧠", label: "Play each additional brain game (up to 5)", pts: 5 },
  { emoji: "🤜", label: "Play first brain game with a tribe member", pts: 25 },
  { emoji: "🤜", label: "Play each additional tribe brain game (up to 5)", pts: 5 },
