...
const SECTION_CONTENT: Record<string, SectionIntroConfig> = {
  ...
  nutrition: {
    ...
    bullets: [
      ...
      { Icon: Wand2, text: "Describe what you ate and tap Estimate — real USDA nutrition data fills in calories, protein, carbs & fat" },
      { Icon: Flame, text: "See your energy in vs. energy out for the day in WELL Check's Nourishment Balance" },
