...
const GratitudeMatchPreview = () => {
  ...
  const wellBack = (
    <svg viewBox="0 0 28 18" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-4 opacity-25">
      <polyline points="1,3 5,15 9,6 13,15 17,3"/>
      <line x1="21" y1="3" x2="21" y2="15"/><line x1="21" y1="15" x2="27" y2="15"/>
    </svg>
  );
  return (
    <div className="flex flex-col items-center gap-2 py-2">
