...
const FAQ_SECTIONS: FAQSection[] = [
  ...
  {
    title: "WELL Cup Prizes",
    icon: <Trophy size={14} />,
    items: [
      {
        q: "How do I win the free month of WELL Collective?",
        a: "The member with the highest point total at the end of each calendar month wins a free month of WELL Collective membership. Points reset to zero at the start of each new month, so every month is a fresh competition. The winner is announced in the app and contacted directly.",
      },
      {
