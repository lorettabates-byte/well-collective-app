...
const ACTIVITY_META: Record<string, { emoji: string; label: string }> = {
  ...
  tribe_challenge_complete: { emoji: "🎮", label: "Tribe brain game played" },
  tribe_challenge_extra:    { emoji: "🎮", label: "Tribe brain game (bonus)" },
  brain_game:               { emoji: "🧠", label: "Brain game" },
  brain_game_extra:         { emoji: "🧠", label: "Brain game (bonus)" },
  referral_signup:          { emoji: "🎁", label: "Referral signup" },
...
const POINTS_GUIDE: { emoji: string; label: string; pts: number | string }[] = [
  ...
  { emoji: "🧠", label: "Play a brain game (first of day)", pts: 20 },
  { emoji: "🧠", label: "Each additional brain game (up to 5 more)", pts: 5 },
  { emoji: "🎮", label: "Play a brain game with a tribe member (first)", pts: 25 },
  { emoji: "🎮", label: "Each additional tribe brain game (up to 5)", pts: 5 },
